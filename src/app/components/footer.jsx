...
export default function Footer() {
    return (
        <footer className="bg-zinc-200 text-black py-8">
            <div className="container mx-auto px-4">
                <div className="flex flex-wrap justify-between">
                    <div className="w-full md:w-1/3 mb-6 md:mb-0">
                        <h5 className="text-lg font-bold mb-4">FieldRaven</h5>
                        <p className="text-sm"
                            style={{ paddingRight: 30 }}
                        > Your health and well-being are our top priority. We provide trusted medical information, resources, and support to help you make informed decisions about your health.
                        </p>
                    </div>
                    <div className="w-full md:w-1/3 mb-6 md:mb-0">
                        ...
                        </ul> </div> <div className="w-full md:w-1/3">
                ...
                <div className="mt-8 border-t border-gray-700 pt-4 text-center">
                    <p className="text-sm">&copy; 2024 FieldRaven. All rights reserved.</p>
                </div>
            </div>
        </footer>
    );
