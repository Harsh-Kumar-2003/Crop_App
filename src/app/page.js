        ...
        <div className="md:h-16 h-28 mx-auto md:px-4 container flex items-center justify-between flex-wrap md:flex-nowrap">
          ...
          <div className="text-gray-500 order-3 w-full md:w-auto md:order-2">
            <ul className="hidden md:flex font-semibold justify-between">
              ...
              <form className="max-w-md mx-auto" style={{ paddingLeft: 20 }}>
                <label
                  htmlFor="default-search"
                  className="mb-0 text-sm font-medium text-gray-900 sr-only dark:text-white"
                >
                  Search
                </label>
        ...
        <div className="flex flex-wrap justify-center gap-8">
          <div className="bg-white p-6 rounded-lg shadow-md flex flex-col items-center text-center">
            ...
            <div className="mt-4">
              ...
              <p className="mt-2 text-gray-600">
                Crop protection is a crucial aspect of agriculture that focuses
                on safeguarding crops from pests, diseases, and environmental
                challenges to maximize yield, ensure sustainability, and
                strengthen food security. As agriculture faces increasing
                pressures from population growth and climate change, adopting
                integrated pest management (IPM) strategies, which combine
                biological, cultural, and chemical methods, becomes essential.
                Farmers employ techniques like precision agriculture and genetic
                engineering to monitor crop health and enhance resilience
                against threats, while sustainable practices, such as crop
                rotation and the use of biopesticides, promote ecological
                balance. By prioritizing effective crop protection, farmers can
                secure their harvests, bolster economic stability, and
                contribute to a more sustainable and food-secure future.
              </p>
            </div>
          </div>
          <div className="about-card bg-white p-6 rounded-lg shadow-md flex flex-col items-center text-center">
            ...
            <div className="mt-4">
              ...
              <p className="mt-2 text-gray-600">
                Crop recommendation involves suggesting the most suitable crops
                to grow in a specific area based on various factors such as
                climate, soil type, and market demand. This process takes into
                account local weather patterns, soil health, and nutrient
                availability, as well as regional agricultural practices. By
                analyzing these variables, crop recommendations can help farmers
                optimize their yields, reduce crop failures, and enhance
                sustainability. Advanced tools such as data analytics, machine
                learning, and geographic information systems (GIS) can further
                refine these recommendations. Ultimately, effective crop
                recommendation supports food security and boosts the
